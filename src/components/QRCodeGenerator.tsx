    ...
    <div className="relative overflow-hidden group">
      ...
      <div className="space-y-2 mb-4">
        <CardAction
          ...
          variant="outline"
          size="sm"
          className="w-full flex items-center justify-center space-x-1 py-2 px-3 transition-all duration-200 hover:scale-105"
        >
        ...
        <CardAction
          ...
          variant="primary"
          size="sm"
          className="w-full flex items-center justify-center space-x-1 py-2 px-3 transition-all duration-200 hover:scale-105 text-white"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
