              ...
              {submittedRating >= 4 && userProfile?.googleMapsUrl && (
                <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border border-blue-100 dark:border-blue-800">
                  ...
                  <a
                    ...
                    className="google-maps-btn inline-flex items-center px-6 py-3 bg-blue-600 font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
                    style={{ 
